        ...
        mockMvc.perform(multipart("/records")
                ...
                .andDo(document("record/save-record",
                        ...
                        requestPartFields("recordInfo", List.of(
                                ...
                                fieldWithPath("starScore").type(JsonFieldType.NUMBER).description("별점 (0.5~5.0)"),
                                fieldWithPath("scentScore").type(JsonFieldType.NUMBER).description("향점수 (0.5~5.0)"),
                                fieldWithPath("tasteScore").type(JsonFieldType.NUMBER).description("맛점수 (0.5~5.0)"),
                                fieldWithPath("textureScore").type(JsonFieldType.NUMBER).description("감촉점수 (0.5~5.0)"),
        ...
        mockMvc.perform(get("/records/{recordId}", recordId))
                ...
                .andDo(document("record/get-record-by-recordId",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("record.starScore").type(JsonFieldType.NUMBER).description("별점(0.5~5.0)"),
                                fieldWithPath("record.scentScore").type(JsonFieldType.NUMBER).description("향 점수(0.5~5.0)"),
                                fieldWithPath("record.tasteScore").type(JsonFieldType.NUMBER).description("맛점수 (0.5~5.0)"),
                                fieldWithPath("record.textureScore").type(JsonFieldType.NUMBER).description("감촉점수 (0.5~5.0)"),
